...
async def amireallyalive(alive):
    ...
    await alive.edit("**`OYE ZINDA HU ABI TU KYA SAMJA MAR GYA? JABTAK YE KHEL KHATAM NHI HOTA APUN IDHARICH HAI ψ(｀∇´)ψ`**\n\n"
                     "`Telethon version: 6.9.0\nPython: 3.7.3\nfork by:` @ItS_PaHuL\n"
                     "`Bot created by:` [iTsPaHuL](tg://user?id=836334838)\n"
                     "`Database Status: Databases functioning normally!\n\nAlways with you, my master!\n`"
                     f"`My pROEST oF pros owner`: {DEFAULTUSER}\n"
                     "[Apna TIME Aaya HAI AAYA THA AND AAYA RAHEGA♥️]"
